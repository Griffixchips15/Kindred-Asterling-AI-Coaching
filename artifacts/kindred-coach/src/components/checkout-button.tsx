...
// Starts an in-app Square checkout. If the visitor isn't signed in yet we send
// them through login first (returning to /pricing) so the Square payment is tied
